...
select animals.name, favorite_foods.name from animals join favorite_foods on animals.favorite_food_id = favorite_foods.food_id where favorite_foods.vegetarian = 1;
